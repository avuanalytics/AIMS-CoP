		...
		public function setSections() {
			...
			$this->sections[] = array(
				...
				'fields'	 => array(
					...
					array(
						'id'		 => 'footer_credits_switch',
						'type'		 => 'switch',
						'title'		 => __( 'Footer credit image', 'onesocial' ),
						'subtitle'	 => __( 'Upload your custom credit image to show in footer (280px by 80px).', 'onesocial' ),
						'default'	 => '0',
						'on'		 => __( 'On', 'onesocial' ),
						'off'		 => __( 'Off', 'onesocial' ),
					),
					array(
						'id'		 => 'boss_footer_credit_image',
						'type'		 => 'media',
						'url'		 => false,
						'required'	 => array( 'footer_credits_switch', 'equals', '1' ),
					),
				)
			);
			...
			// Homepage Settings
			$this->sections[] = array(
				'title'		 => __( 'Homepage Settings', 'onesocial' ),
				'icon'		 => 'el-icon-wrench',
				'customizer' => false,
				'fields'	 => array(
					array(
						'id'		 => 'home_header_text_option',
						'type'		 => 'switch',
						'title'		 => __( 'Show home welcome text', 'onesocial' ),
						'subtitle'	 => __( 'Toggle home page text (bellow slider/banner) on or off.', 'onesocial' ),
						'default'	 => '1',
						'on'		 => __( 'On', 'onesocial' ),
						'off'		 => __( 'Off', 'onesocial' ),
					),
				/*	array(
						...
						'required'	 => array( 'home_header_text_option', 'equals', '1' ),
					),*/
					/*array(
						'id'		 => 'header_home_title',
						'type'		 => 'text',
						'title'		 => __( 'Home Page Body Title', 'onesocial' ),
						'default'	 => __( 'Welcome to the AIMS Community of Practice', 'onesocial' ),
						'required'	 => array( 'home_header_text_option', 'equals', '1' ),
					),
					array(
						'id'		 => 'header_home_description',
						'type'		 => 'textarea',
						'title'		 => __( 'Home Page Body Description', 'onesocial' ),
						'default'	 => __( '', 'onesocial' ),
						'required'	 => array( 'home_header_text_option', 'equals', '1' ),
					),*/
					array(
						'id'		 => 'home_page_forums_option',
						'type'		 => 'switch',
						'title'		 => __( 'Show forums on home page', 'onesocial' ),
						'subtitle'	 => __( 'Toggle home page forums visibility on or off.', 'onesocial' ),
						'default'	 => '1',
						'on'		 => __( 'On', 'onesocial' ),
						'off'		 => __( 'Off', 'onesocial' ),
					),
					/*array(
						'id'		 => 'home_page_forums_section_header',
						'type'		 => 'text',
						'title'		 => __( 'Home Page Forums Section Header', 'onesocial' ),
						'default'	 => __( 'Communities', 'onesocial' ),
						'required'	 => array( 'home_page_forums_option', 'equals', '1' ),
					),*/
					array(
						'id'		 => 'home_page_forums_section_total',
						'type'		 => 'text',
						'title'		 => __( 'Forums Count on Homepage', 'onesocial' ),
						'default'	 => __( '6', 'onesocial' ),
						'required'	 => array( 'home_page_forums_option', 'equals', '1' ),
					),
					array(
						'id'		 => 'home_page_posts_option',
						'type'		 => 'switch',
						'title'		 => __( 'Show latest community posts on home page', 'onesocial' ),
						'subtitle'	 => __( 'Toggle home page community posts visibility on or off.', 'onesocial' ),
						'default'	 => '1',
						'on'		 => __( 'On', 'onesocial' ),
						'off'		 => __( 'Off', 'onesocial' ),
					),
					/*array(
						'id'		 => 'home_page_posts_section_header',
						'type'		 => 'text',
						'title'		 => __( 'Home Page Latest Posts Section Header', 'onesocial' ),
						'default'	 => __( 'Latest Community Posts', 'onesocial' ),
						'required'	 => array( 'home_page_posts_option', 'equals', '1' ),
					),*/
					array(
						'id'		 => 'home_page_posts_section_total',
						'type'		 => 'text',
						'title'		 => __( 'Latest Posts Count on Homepage', 'onesocial' ),
						'default'	 => __( '3', 'onesocial' ),
						'required'	 => array( 'home_page_posts_option', 'equals', '1' ),
					)
